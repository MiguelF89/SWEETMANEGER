                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('produtos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="preco" id="preco" step="0.01" class="w-full px-3 py-2 border border-gray-300 rounded @error('preco') border-red-500 @enderror" value="{{ old('preco') }}">
                            @error('preco')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
