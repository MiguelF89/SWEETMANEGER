                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('vendas.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="quantidade" id="quantidade" class="w-full px-3 py-2 border border-gray-300 rounded @error('quantidade') border-red-500 @enderror" value="{{ old('quantidade') }}" min="1">
                            @error('quantidade')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
